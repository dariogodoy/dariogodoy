    ...
    <foreignObject x="0" y="0" width="100%" height="100%">
        <div xmlns="http://www.w3.org/1999/xhtml" xmlns:xlink="http://www.w3.org/1999/xlink" class="items-wrapper">
            ...
            <section class="column">
                ...
                <small>estimation from 397kb of code in 463 edited files across 140 commits over last 14 days</small>
                <svg class="bar" xmlns="http://www.w3.org/2000/svg" width="460" height="8">
                    <mask id="languages-bar">
                        <rect x="0" y="0" width="460" height="8" fill="white" rx="5"/>
                    </mask>
                    <rect mask="url(#languages-bar)" x="0" y="0" width="0" height="8" fill="#d1d5da"/>
                    <rect mask="url(#languages-bar)" x="0" y="0" width="364.3181874153429" height="8" fill="#3178c6"/>
                    <rect mask="url(#languages-bar)" x="364.3181874153429" y="0" width="67.94549111357385" height="8" fill="#ededed"/>
                    <rect mask="url(#languages-bar)" x="432.2636785289168" y="0" width="27.7363214710832" height="8" fill="#f1e05a"/>
                </svg>
